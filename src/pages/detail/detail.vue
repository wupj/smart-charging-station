<template>
  <view class="detail-container">
    ...
    <view class="station-info">
      ...
      <image class="station-image" src="https://picsum.photos/seed/charging-station/800/400.jpg" mode="aspectFill" />
      ...
      <view class="action-section">
        ...
        <view class="action-icons">
          ...
          <view class="action-icon" @click="toggleFavorite">
            <uni-icons :type="isFavorite ? 'star-filled' : 'star'" size="20" :color="isFavorite ? '#f39c12' : '#95a5a6'"></uni-icons>
          </view>
    ...
    <view class="tab-content">
      ...
      <view v-if="activeTab === 'piles'" class="piles-grid">
        <view class="pile-row">
          <view class="pile-card">
            ...
            <image class="pile-image" src="https://picsum.photos/seed/charging-pile-1/200/200.jpg" mode="aspectFit" />
          ...
          <view class="pile-card available">
            ...
            <image class="pile-image" src="https://picsum.photos/seed/charging-pile-2/200/200.jpg" mode="aspectFit" />
        ...
        <view class="pile-row">
          <view class="pile-card in-use">
            ...
            <image class="pile-image" src="https://picsum.photos/seed/charging-pile-3/200/200.jpg" mode="aspectFit" />
          ...
          <view class="pile-card suspended">
            ...
            <image class="pile-image" src="https://picsum.photos/seed/charging-pile-4/200/200.jpg" mode="aspectFit" />
      ...
      <view v-if="activeTab === 'photos'" class="photos-content">
        ...
        <image class="photo-item" src="https://picsum.photos/seed/station-scene-1/400/300.jpg" mode="aspectFill" />
        <image class="photo-item" src="https://picsum.photos/seed/station-scene-2/400/300.jpg" mode="aspectFill" />
      </view>
    </view>
  </view>
</template>
