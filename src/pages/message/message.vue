  ...
  const messages = ref([
    {
      ...
      unread: true,
      detail:
        '您的充电订单已成功支付。订单号：20230101123456789。充电桩：1号桩。金额：15.00元。感谢您的使用！'
    },
    {
      id: 2,
      title: '支付成功',
      ...
      unread: false,
      detail:
        '您的充电订单已成功支付。订单号：20230101123456790。充电桩：2号桩。金额：12.50元。感谢您的使用！'
    },
    {
      id: 3,
      title: '设备维护,暂停营业',
      ...
      unread: false,
      detail:
        '尊敬的用户，美华智充元科创新园充电站将于2023年10月26日进行设备维护，届时将暂停营业。维护期间给您带来的不便，敬请谅解。预计恢复时间：2023年10月27日08:00。'
    },
    {
      id: 4,
      title: '充电完成',
      ...
      unread: false,
      detail:
        '您的充电已完成。充电桩：3号桩。充电时长：2小时30分钟。充电电量：45.6kWh。费用：68.40元。请及时移车，方便其他用户使用。'
    },
    {
      id: 5,
      title: '系统通知',
      ...
      unread: false,
      detail:
        '新用户专享福利！首次使用美华智充充电服务，即可享受8折优惠。活动时间：2023年10月1日-10月31日。快来体验吧！'
    }
  ])
