  ...
  <view class="add-vehicle-container">
    ...
    <view class="content">
        ...
        <view class="plate-input-container">
          <view class="plate-inputs">
            <view 
              ...
              :class="{ 'filled': char !== '', 'new-energy': index === 7 && isNewEnergy }"
              @click="focusInput(index)"
            >
              <text v-if="char !== ''">{{ char }}</text>
              <text v-else class="placeholder">{{ index === 0 ? '省' : '' }}</text>
            </view>
          </view>
      ...
      <view class="notice-section">
        <text class="notice-text">请绑定真实有效的车牌号,否则将无法正常使用车牌进行付费。</text>
      </view>
    </view>
...
const keyboardKeys = ['1', '2', '3', '4', '5', '6', '7', '8', '9', '0', 'A', 'B', 'C', 'D', 'E', 'F', 'G', 'H', 'J', 'K', 'L', 'M', 'N', 'P', 'Q', 'R', 'S', 'T', 'U', 'V', 'W', 'X', 'Y', 'Z']
