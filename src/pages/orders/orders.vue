    ...
    <view class="tab-content">
      ...
      <view v-if="activeTab === 'charging'" class="charging-content">
        ...
        <view class="action-section">
          <button class="end-charging-btn" @click="endCharging">
            <uni-icons type="close-filled" size="20" color="#ffffff"></uni-icons>
      ...
      <view v-if="activeTab === 'consumption'" class="consumption-content">
        <view class="consumption-list">
          <view v-for="record in consumptionRecords" :key="record.id" class="consumption-item" @click="goToDetail(record.id)">
...
.charging-progress {
  ...
  .progress-circle {
    ...
    background: conic-gradient(from 0deg, #ecf0f1 0%, #3498db 66%, #ecf0f1 66%, #ecf0f1 100%);
    position: relative;
    display: flex;
    align-items: center;
    justify-content: center;
